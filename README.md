...
* Most Adequate Model to predict the mean and volatility of the Apple stock prices: ARMA(0,0) - EGARCH(1,1) model with t distribution
* Captures the asymmetric volatility behavior of Apple stock return n
